...
public class MinioUtils {
    @Autowired
    private MinioClient client;      // MinIO 客户端（已配置好地址、账号密码）
    @Autowired
    private MinioProp minioProp;     // 配置类，包含 endpoint、accessKey 等
     ...
     * @return
     */
    public JSONObject uploadFile(MultipartFile file, String
        ...
        res.put("msg", minioProp.getEndpoint() + "/" + bucketName
                + "/" + fileName);
        return res;
    }
}